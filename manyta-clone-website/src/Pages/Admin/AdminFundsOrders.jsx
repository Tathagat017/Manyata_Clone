import { Box, Flex ,Table,TableCaption,TableContainer,Tbody,Td,Text, Th, Thead, Tr,Input, useDisclosure ,Button, Heading, Highlight, Stack} from '@chakra-ui/react'
import {
  Stat,
  StatLabel,
  StatNumber,
            ...
            <Table   size={'sm'} variant='striped' colorScheme='pink'>
              ...
              <Tbody>
                  ...
                  {products===undefined?<Tr><Td>...loading</Td></Tr>:products.map((el)=>(
                    <TableData2 key={el.id} {...el} trigger={trigger} setrigger={setrigger} settotalfunds={settotalfunds} totalfunds={totalfunds} burn={burn} setburn={setburn} />
                  ))}
